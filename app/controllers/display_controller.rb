class DisplayController < ApplicationController
  ...
  def index
    ...
    forecast = response = HTTParty.get("http://api.openweathermap.org/data/2.5/forecast/daily?q=clearwater,us&units=imperial&APPID=44e5ea9665216f4fa7621cf0ce5b3732&#{random}")
